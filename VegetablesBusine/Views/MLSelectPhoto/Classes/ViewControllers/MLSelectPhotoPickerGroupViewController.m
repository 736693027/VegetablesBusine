...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [self allowPhotoStateBlock:^(BOOL result) {
        if(!result){
            [JCAlertView showOneButtonWithTitle:@"照片调用失败" Message:@"请在通用-路宝助手-照片中允许使用照片功能" ButtonType:JCAlertViewButtonTypeCancel ButtonTitle:@"确定" Click:^{
...
//相册权限
- (void)allowPhotoStateBlock:(void (^)(BOOL result))stateBlock{
