...
- (void)showMessageWithText:(NSString *)text{
    ...
    alertLabel.ml_x = ([UIScreen mainScreen].bounds.size.width - alertLabel.ml_width) * 0.5;
    alertLabel.ml_y = ([UIScreen mainScreen].bounds.size.height - alertLabel.ml_height) * 0.5;
